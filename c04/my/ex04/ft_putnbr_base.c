...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/11 09:56:48 by hannkim           #+#    #+#             */
/*   Updated: 2021/03/14 00:18:00 by hannkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		len_nbr(long long nbr, int b_len)
{
	int len;
...
void	rec_parse(long long nbr, char *base, int b_len, int n_len)
{
	char	ch;
